 ...
 */
@WebServlet(name = "FruitsCharServlet", urlPatterns = {"/FruitsCharServlet"})
public class FruitsCharServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        IFruits port = service.getFruitsImplPort();
            ...
            List<Fruits> fruitsChar = port.getAllFruitsByChar(searchBox);
     
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
            out.println(HelperClass.getHTMLChar(fruitsChar, "List of my Fruits Searched By The Character"));
